...
public class Main {
    public static void main(String[] args) {
        ...
        bootcamp.setNome("Bootacamp Java");
        ...
        devManu.progredir();
        System.out.println("----");
        System.out.println("Conteúdos incritos Manu: " + devManu.getConteudosInscritos());
        System.out.println("Conteúdos concluídos Manu: " + devManu.getConteudosConcluidos());
